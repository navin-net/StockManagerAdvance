<header class="app-header shadow-sm">
    <div class="container-fluid d-flex align-items-center justify-content-between h-100 px-3">
        ...
        <div class="d-flex align-items-center gap-2 ">
            ...
            <!-- 🌐 Language Switch -->
            <div class="btn-group">
                <button class="btn nbt-outline-custom dropdown-toggle" type="button"
            ...
            <!-- ⚠️ Alerts -->
            <div class="btn-group">
                <button class="btn btn-outline-danger position-relative dropdown-toggle"
                        data-bs-toggle="dropdown">
        ...
        @if (request()->is('admin/pos*'))
            <div class="d-flex gap-1 align-items-center desktop-only">
                ...
                <!-- Alerts / Cart -->
                <div class="dropdown">
                    <button class="btn btn-danger position-relative" id="cartIcon" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-exclamation-triangle-fill"></i>
                    ...
                    <div class="dropdown-menu dropdown-menu-end p-2" style="width: 300px;" id="alertContainer">
                        ...
                        <hr class="dropdown-divider">
                        <a class="dropdown-item text-center" href="{{ url('/products') }}">{{ __('messages.see_all') }}</a>
                    </div>
                </div>

                <!-- Info Button -->
                <button type="button" class="btn btn-info text-white d-flex align-items-center justify-content-center"
