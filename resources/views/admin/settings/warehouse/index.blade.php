                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu shadow-sm rounded-3">
                                    <li><a class="dropdown-item" href="#" id="addWarehouseBtn">{{ __('messages.add') }}</a></li>
                                    <li><a class="dropdown-item" href="#" id="bulkDeleteBtn" disabled>{{ __('messages.delete') }}</a></li>
                                </ul>
                            </div>
                        </div>
                        <!-- Alerts -->
            ...
            <div class="modal-content rounded-3 border-0 shadow">
                ...
                <form id="createWarehouseForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="name" class="form-label fw-medium">Warehouse Name <span class="text-danger">*</span></label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3 border-0 shadow">
                ...
                <form id="editWarehouseForm">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="editName" class="form-label fw-medium">Warehouse Name <span class="text-danger">*</span></label>
...
<script>
    $(document).ready(function() {
            ...
            columns: [
                {
                    ...
                    render: function(data) {
                        return `<input type="checkbox" class="warehouseCheckbox" value="${data}">`;
                    },
                    orderable: false,
                    searchable: false
        ...
        $('#selectAll').on('click', function() {
            $('.warehouseCheckbox').prop('checked', $(this).prop('checked'));
        ...
        function toggleBulkDeleteButton() {
            const anyChecked = $('.warehouseCheckbox:checked').length > 0;
