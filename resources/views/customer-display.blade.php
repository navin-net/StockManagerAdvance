...
/* everything above bg */
header, #idle, #order, #thankyou { position: relative; z-index: 1; }
...
@keyframes globe-orbit {
  0%   { transform: translateX(12px) translateY(0px); opacity: 1; }
  25%  { transform: translateX(0px) translateY(-8px); opacity: 0.7; }
  50%  { transform: translateX(-12px) translateY(0px); opacity: 0.3; }
  75%  { transform: translateX(0px) translateY(8px); opacity: 0.7; }
  100% { transform: translateX(12px) translateY(0px); opacity: 1; }
}
...
.tz-time.local { color: var(--aurora1); }
...
.greeting-lang.visible { opacity: 1; }
...
.arc1 { border-top-color: rgba(0,201,177,0.15); animation-duration: 18s; }
.arc2 { inset: 40px; border-right-color: rgba(0,153,255,0.1); animation-duration: 24s; animation-direction: reverse; }
.arc3 { inset: 80px; border-bottom-color: rgba(123,94,167,0.12); animation-duration: 32s; }
...
@keyframes slide-ticker { from { transform: translateX(0); } to { transform: translateX(-50%); } }
.ticker-item {
  padding: 0 28px;
  font-family: var(--font-mono);
  font-size: 11px;
...
.ticker-item.hi { color: var(--aurora1); }
...
.items-panel::-webkit-scrollbar { width: 3px; }
.items-panel::-webkit-scrollbar-thumb { background: var(--space5); border-radius: 2px; }
...
.sum-row.disc { color: var(--aurora1); }
.sum-row span:last-child { font-family: var(--font-mono); }

.grand-zone { margin-top: auto; }
...
.grand-box::before { top: 0; left: 0; border-width: 1px 0 0 1px; }
.grand-box::after  { bottom: 0; right: 0; border-width: 0 1px 1px 0; }
...
.ty-ring:nth-child(1) { width: 100px; height: 100px; animation-delay: 0s; }
.ty-ring:nth-child(2) { width: 100px; height: 100px; animation-delay: 0.8s; border-color: var(--aurora2); }
.ty-ring:nth-child(3) { width: 100px; height: 100px; animation-delay: 1.6s; border-color: var(--aurora3); }
@keyframes ring-expand {
  from { width: 60px; height: 60px; opacity: 0.6; }
...
.ty-ld.hi { color: var(--ivory2); border-color: var(--wire); }
</style>
</head>
<body>
    ...
    <div class="totals-panel">
      ...
      <div class="grand-zone">
        <div class="grand-box">
          ...
          <div class="grand-amt"><span class="cur" id="dCur">$</span><span id="dGrandNum">0.00</span></div>
        </div>
