...
<head>
    ...
    <title>Page 404 Black Box</title>
    <!-- Style -->
...
<main id="main" class="main">
    ...
    {{-- <div id="menu-page" class="menu-page">
        <div class="social_box">
            ...
            <a href="#">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                    <linearGradient id="MJy9k6AlNL0BTsRkEkukAa" x1="8.455" x2="40.88" y1="7.883" y2="41.5"
                                    gradientUnits="userSpaceOnUse">
    ...
    <!-- image -->
    <div class="image"><img id="big_image" src="{{ asset('backend/image/astronaut.png') }}" alt="#"></div>
</main>
<!-- start ----- image-box (Delete this) ----- -->
<div id="image-box" class="image-box">
    <div id="close_ImageBox">X</div>
    <img class="small_image active" src="{{ asset('backend/image/astronaut.png') }}" style="max-width: 50%;animation-delay: 800ms;" alt="#">
    <img class="small_image" src="{{ asset('backend/image/cute-ghost.png') }}" style="max-width: 80%;animation-delay: 900ms;" alt="#">
    <img class="small_image" src="{{ asset('backend/image/female.png') }}" style="max-width: 50%;animation-delay: 1000ms" alt="#">
    <img class="small_image" src="{{ asset('backend/image/sad-boy.png') }}" style="max-width: 70%;animation-delay: 1100ms;" alt="#">
    <img class="small_image" src="{{ asset('backend/image/Searcher.png') }}" style="max-width: 80%;animation-delay: 1200ms" alt="#">
    <img class="small_image" src="{{ asset('backend/image/cherry.png') }}" style="max-width: 60%;animation-delay: 1300ms" alt="#">
</div>
...
<script>
    ...
    if (toggle) {
        toggle.addEventListener("click", function () {
            if (!menuitem) return; // menu page may be commented out
            if (menuitem.classList.contains("active")) {
                ...
                menuitem.style.height = (main ? (main.offsetHeight - 2) : 0) + "px"
    ...
    const closeBtn = document.getElementById("close_ImageBox");
    if (closeBtn && image_box) {
        closeBtn.addEventListener("click", () => image_box.style.display = "none")
    }
    Array.from(small_image).forEach(img => {
    ...
    function switchImage() {
        Array.from(small_image).forEach(i => i.classList.remove("active"))
        if (this && this.classList) this.classList.add("active")
        if (big_image && this && this.src) big_image.src = this.src
        if (big_image && this && this.style) big_image.style.maxWidth = this.style.maxWidth
    }
</script>
</html>
