...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/shop/css/magnific-popup.css') }} " type="text/css">
...
<body>
    ...
    @include('frontend.shop.layouts.hero')
    @yield('content')
    ...
    <script src="{{ asset('frontend/shop/js/jquery.nicescroll.min.js') }} "></script>
    <script src="{{ asset('frontend/shop/js/jquery.magnific-popup.min.js') }} "></script>
    <script src="{{ asset('frontend/shop/js/jquery.countdown.min.js') }} "></script>
