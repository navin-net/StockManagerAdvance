...
<aside class="sidebar">
    <div class="sidebar-user">
        {{-- User Info --}}
        <a href="{{ route('profile.edit', Auth::user()->id) }}" class="nav-link d-flex align-items-center  mb-3 {{ request()->routeIs('profile.edit') ? 'active' : '' }}" >
            @if (Auth::user()->avatar)
    ...
    <div class="p-3">
        ...
        <a class="nav-link d-flex align-items-center justify-content-between {{ request()->is($prefix . '/products*') ? 'active' : '' }}"
            ...
            aria-expanded="{{ request()->is($prefix . '/products*') ? 'true' : 'false' }}"
            aria-controls="shop-nav-products">
            <div>
        ...
        <div class="mb-2">
            <a class="nav-link d-flex align-items-center justify-content-between{{ request()->is($prefix . '/shop/settings*') || request()->is($prefix . '/shop/banners*') ? 'active' : '' }}"
                data-bs-toggle="collapse" data-bs-target="#shop-nav-slider" role="button"
                aria-expanded="{{ request()->is($prefix . '/shop/settings*') || request()->is($prefix . '/shop/banners*') ? 'true' : 'false' }}"
            ...
            <div id="shop-nav-slider"class="collapse{{ request()->is($prefix . '/shop/settings*') || request()->is($prefix . '/shop/banners*') ? 'show' : '' }}
                ps-4 mt-1">
